...
function Faq() {
  return (
    <div className="container mx-auto flex flex-col justify-start items-start pt-28 mb-10">
      <div>
        <h1 className="text-5xl font-bold text-blue-800">FAQ</h1>
      </div>
      <div className=" border border-blue-600 rounded-lg w-2/3 py-1 px-4 mt-10 ">
        <Accordion
      ...
      <div className="border border-blue-600 rounded-lg w-2/3 py-1 px-4 mt-5">
        <Accordion
